...
namespace GotDotNet.XPath {
    ...
    public class XPathReader : XmlReader {
        ...
        public XPathReader(string url, string xpath) : this(){
            this.reader = XmlTextReader.Create(url);
        ...
        // XmlTextReader to process the URL
        //
        public XPathReader(string url, string xpath, XmlReaderSettings settings)
            : this()
        {
            this.reader = XmlTextReader.Create(url, settings);
        ...
        // XmlTextReader to process the URL
        //
        public XPathReader(string url, XPathCollection xc) : this(XmlTextReader.Create(url), xc)
        {
        }

        public XPathReader(string url, XPathCollection xc, XmlReaderSettings settings)
            : this(XmlTextReader.Create(url, settings), xc)
        {
        }
        /// <include file='doc\XPathReader.uex' path='docs/doc[@for="XPathReader.XPathReader1"]/*' />
        /// <internalonly/>
